...
class Data():
    ...
    def preprocess(self, featurization, norm = False):
        self.preprocess_features(self.train_data, featurization, norm)
        self.preprocess_features(self.val_data, featurization, norm)
        self.preprocess_labels(self.train_labels)
        self.preprocess_labels(self.val_labels)
    
    def preprocess_features(self, data, featurization, norm = False):
        ...
        if not self.featurization:
            ...
            if norm:
                self.val_x = self.norm.fit_transform(self.val_x)
